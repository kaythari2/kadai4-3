...
// $m_commons=$controller->getAllMCommon();

$totalRowCount = $dbController->getRowCount(htmlspecialchars($_GET['keyword']), htmlspecialchars($_GET['frame_number']));
...
echo 'Total Row Count >>>> ' . $totalRowCount;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            // $mileageUnitCode = $m_commons[2][$car['mileage_unit_cd']];
                                            $mileageUnitCode = '';
